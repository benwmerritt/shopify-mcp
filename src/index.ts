    ...
    server.tool(
      "products",
      {
        id: z
          ...
          .optional()
          .describe(
            "Product ID for single product lookup (can be numeric or full GID)",
          ),
        title: z
          .string()
          .optional()
        ...
        limit: z
          .number()
          .default(50)
          .describe("Maximum number of products to return (max 100)"),
        cursor: z
          .string()
          .optional()
    ...
    server.tool(
      "orders",
      {
        id: z
          ...
          .optional()
          .describe(
            "Order ID for single order lookup (can be numeric or full GID)",
          ),
        customerId: z
          .string()
          .optional()
          .describe("Filter orders by customer ID (numeric)"),
        status: z
    ...
    server.tool(
      "draft-orders",
      {
        id: z
          ...
          .optional()
          .describe(
            "Draft order ID for single lookup (can be numeric or full GID)",
          ),
        status: z
